...
const CLEAN_SEED_DATA = {
  schoolInfo: {
    ...
    address: "Madina Estate, Adjacent Madina Estate Basic School, P.O. Box LG1003, Legon",
    phone: "0242762740 / 0506913818 / 0240804344",
    ...
    letterhead: {
      ...
      address: "Madina Estate, Adjacent Madina Estate Basic School • P.O. Box LG1003, Legon",
      contact: "TEL: 0242762740 / 0506913818 / 0240804344 | Email: anisa2009@gmail.com",
...
function sanitizeStaffData() {
  ...
  if (schoolData.schoolInfo) {
    ...
    schoolData.schoolInfo.address = "Madina Estate, Adjacent Madina Estate Basic School, P.O. Box LG1003, Legon";
    schoolData.schoolInfo.phone = "0242762740 / 0506913818 / 0240804344";
    ...
    if (schoolData.schoolInfo.letterhead) {
      ...
      schoolData.schoolInfo.letterhead.address = "Madina Estate, Adjacent Madina Estate Basic School • P.O. Box LG1003, Legon";
      schoolData.schoolInfo.letterhead.contact = 'TEL: 0242762740 / 0506913818 / 0240804344 | Email: anisa2009@gmail.com';
    }
  }
...
function openAdminProfileModal() {
  ...
  if (phoneInput) phoneInput.value = dir.phone || '0242762740';
...
async function handleSaveAdminProfile(e) {
  ...
  const phone = document.getElementById('admin-modal-phone').value.trim() || '0242762740';
...
function applyBrandingAndLetterhead() {
  ...
  if (printAddress) {
    printAddress.innerText = lh.address || "Madina Estate, Adjacent Madina Estate Basic School • P.O. Box LG1003, Legon";
  }
  if (printContact) {
    printContact.innerHTML = lh.contact || `TEL: 0242762740 / 0506913818 / 0240804344 | Email: anisa2009@gmail.com`;
  }
